...
public class Tokens {
    ...
    */
      myFile = new TextFileInput("animals.txt"); //can also use args[0]
      line = myFile.readLine();
      System.out.println("The input line is "+line);
   /*
    * Create a new StringTokenizer, passing the String and the delimeter (",")
    */
      myTokens = new StringTokenizer(line,","); //is used to tokenize the string to extract out token/word, the second parameter represents the delimeter
    ...
    */
      ...
      while (myTokens.hasMoreTokens()) {
         animals[i]=myTokens.nextToken(); //return the next word
         i++;
      }
    /*
     * Print the array
